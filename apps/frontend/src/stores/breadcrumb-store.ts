...
interface BreadcrumbStore {
  ...
  setInspectionContext: (
    inspection: { id: string; date: string; hiveId: string } | undefined,
  ) => void;
  setQueenContext: (
    queen: { id: string; name?: string; hiveId?: string } | undefined,
  ) => void;
  setHarvestContext: (
    harvest: { id: string; date: string; hiveId?: string } | undefined,
  ) => void;
