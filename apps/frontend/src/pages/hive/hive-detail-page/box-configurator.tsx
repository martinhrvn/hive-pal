 ...
 */
export const BoxConfigurator = ({ hive }: { hive: HiveDetailResponseDto | undefined }) => {
  return (
    <div>
      <Card className="mb-4">
        <CardHeader>
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            This section allows you to configure the boxes in your hive.
            You can add, remove, and reorder boxes to match your physical hive setup.
          </p>
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-md p-4">
                {hive.boxes.map((box, index) => (
                  <div key={box.id || index} className="p-3 border border-dashed rounded-md mb-2">
