            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    This action cannot be undone. This will permanently delete the harvest.
                  </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                  <DialogClose asChild>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <p className="font-medium">{format(new Date(harvest.date), 'PPP')}</p>
            </div>
            <div>
            ...
            <div>
              ...
              {harvest.status !== HarvestStatus.COMPLETED && !harvest.totalWeight && !isEditingWeight ? (
                <Button
                  variant="outline"
                  size="sm"
                ...
                <div className="flex space-x-2">
                  ...
                  <Button size="sm" onClick={handleSetWeight}>Save</Button>
                  <Button 
                    size="sm" 
                    variant="outline"
                    onClick={() => {
                ...
                <p className="font-medium">
                  {harvest.totalWeight ? `${harvest.totalWeight} kg` : 'Not set'}
                </p>
              )}
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              {harvest.status !== HarvestStatus.COMPLETED && !isEditingNotes && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => {
              ...
              >
                ...
                {hh.honeyAmount && (
                  <div className="text-right">
                    <p className="font-medium">{hh.honeyAmount.toFixed(2)} kg</p>
                    <p className="text-sm text-muted-foreground">
