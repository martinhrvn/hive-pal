...
test('Admin can view users', async ({ page, isMobile }) => {
...
test('Admin can reset password', async ({ page, browser }) => {
    ...
    await signupPage.signUp(name, password, 'Forgetful Sam')
