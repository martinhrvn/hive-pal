...
export class InspectionsController {
  ...
  create(
    ...
    this.logger.log(`Creating inspection for hive ${createInspectionDto.hiveId} in apiary ${req.apiaryId}`);
  ...
  findAll(
    ...
    this.logger.log(`Finding inspections for apiary ${req.apiaryId}${query.hiveId ? `, hive ${query.hiveId}` : ''}`);
  ...
  findOne(@Param('id') id: string, @Req() req: RequestWithApiary) {
    this.logger.log(`Finding inspection with ID ${id} in apiary ${req.apiaryId}`);
  ...
  update(
    ...
    this.logger.log(`Updating inspection with ID ${id} in apiary ${req.apiaryId}`);
  ...
  remove(@Param('id') id: string, @Req() req: RequestWithApiary) {
    this.logger.log(`Removing inspection with ID ${id} from apiary ${req.apiaryId}`);
