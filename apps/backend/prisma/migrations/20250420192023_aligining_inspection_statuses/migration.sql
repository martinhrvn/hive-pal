/*
  ...
  - The values [PENDING] on the enum `InspectionStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "InspectionStatus_new" AS ENUM ('SCHEDULED', 'OVERDUE', 'COMPLETED', 'CANCELLED');
